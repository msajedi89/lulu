...
export class StudentrecitequranPage implements OnInit {
  ...
  goNext() {
    ...
    // record the result
    this.network.recordStudentReciteQuran(this.stExamID, this.stID, this.QID, this.stVoiceFileName, this.fromWhere).then(result => {
