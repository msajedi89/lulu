...
var AnswertypequestionsPage = /** @class */ (function () {
    function AnswertypequestionsPage(router, platform, network, toastController, actionSheetController, camera, transfer, navCtrl, media, file) {
        this.router = router;
    ...
    AnswertypequestionsPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    AnswertypequestionsPage.prototype.goBack = function () {
        this.router.navigate(['members', 'questions']);
    };
    // ***************** Main Title Select *****************
    AnswertypequestionsPage.prototype.userChanged = function (event) {
        console.log('event: ', event);
        console.log('users: ', this.mainTitle);
    };
    // when select component has been closed.
    AnswertypequestionsPage.prototype.onClose = function () {
        var _this = this;
    ...
    // show a Toast.
    AnswertypequestionsPage.prototype.presentToast = function (text) {
    ...
    AnswertypequestionsPage.prototype.selectImage = function (root, imageName) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var actionSheet;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
    ...
    AnswertypequestionsPage.prototype.takePicture = function (root, imageName) {
        var _this = this;
        var options = {
            quality: 70,
    ...
    AnswertypequestionsPage.prototype.getPicture = function (root, imageName) {
        var _this = this;
        var options = {
            quality: 70,
            destinationType: this.camera.DestinationType.DATA_URL,
    ...
    AnswertypequestionsPage.prototype.insertImage = function (realImage, imgName, root) {
        var _this = this;
    ...
    AnswertypequestionsPage.prototype.uploadImage = function (image) {
        var _this = this;
    ...
    AnswertypequestionsPage.prototype.createFileName = function () {
        var d = new Date(), n = d.getTime(), newFileName = n + ".jpg";
        return newFileName;
    };
    // **************** Question Audio Part *****************
    // the method for starting the recorder to record audio
    AnswertypequestionsPage.prototype.startAudio = function (root, voiceNameEn, voiceNameAr) {
    ...
    AnswertypequestionsPage.prototype.generateAudioFileName = function () {
        var d = new Date(), n = d.getTime(), newFileName = n + ".m4a";
        return newFileName;
    };
    //the method for stopping the recorder
    AnswertypequestionsPage.prototype.stopAudio = function (root, voiceNameEn, voiceNameAr) {
        if ((voiceNameEn != null) && (voiceNameAr != null)) {
            if (root == "question") {
    ...
    AnswertypequestionsPage.prototype.playAudio = function (file, root) {
        if (root == "question") {
            if (this.platform.is('ios')) {
    ...
    AnswertypequestionsPage.prototype.insertVoice = function (audioFileName, audioFilePath, audioNameEn, audioNameAr, root) {
        var _this = this;
        // Upload Voice
    ...
    AnswertypequestionsPage.prototype.uploadAudio = function (audioFileName, audioFilePath) {
        var _this = this;
        var fileTransfer = this.transfer.create();
        var options = {
            fileKey: 'audio',
    ...
    AnswertypequestionsPage.prototype.insertQuestion = function (name, question, questionAr, questionAz, maxTime, descriptionEn, descriptionAr) {
        var _this = this;
        if (questionAr == null) {
            questionAr = "";
        }
        ...
        if ((name != null) && (question != null) && (this.mainTitle != null) && (this.subTitle != null)) {
            var myQuestionID_1;
            this.network.insertQuestion(name, this.mainTitle.mtID, this.subTitle.SubTID, maxTime, question, questionAr, questionAz, this.myQuestionVoiceID, this.myQuestionImgID, descriptionEn, descriptionAr, 4).then(function (data) {
    ...
    AnswertypequestionsPage.prototype.showData = function (data) {
        var jsonArray = data;
    ...
    ], AnswertypequestionsPage.prototype, "selectComponent", void 0);
    AnswertypequestionsPage = tslib_1.__decorate([
        Component({
        ...
        tslib_1.__metadata("design:paramtypes", [Router, Platform, NetworkEngineService, ToastController,
            ...
            Media, File])
    ], AnswertypequestionsPage);
    return AnswertypequestionsPage;
}());
export { AnswertypequestionsPage };
//# sourceMappingURL=answertypequestions.page.js.map