...
var WHOIS = 'whois';
var EvaluationofdrawingquestionsPage = /** @class */ (function () {
    function EvaluationofdrawingquestionsPage(router, platform, network, navCtrl, storage, toastCtrl) {
        var _this = this;
        this.router = router;
    ...
    EvaluationofdrawingquestionsPage.prototype.ngOnInit = function () {
        var _this = this;
        // get the Student ID
                    ...
                    if (_this.fromWhere == 'exam') {
                        ...
                        _this.storage.get(STUDENTEXAMID).then(function (resultstExamID) {
                            ...
                            _this.network.getQuestionByID(_this.QID).then(function (data) {
                                ...
                                console.log('the question is: ' + JSON.stringify(_this.question));
                                _this.network.getStudentDrawingAnswer(_this.stID, _this.stExamID, _this.QID, _this.fromWhere).then(function (stAnswerData) {
                                    ...
                                    if (_this.studentAnswer == '0') {
                                        ...
                                        _this.image = _this.network.mainStudentsDrawingURL + _this.studentAnswer.stDrawLetter;
                                    }
                                });
                            });
                        });
    ...
    EvaluationofdrawingquestionsPage.prototype.goBack = function () {
    ...
    EvaluationofdrawingquestionsPage.prototype.recordScore = function (score, evaluationDescription) {
        var _this = this;
        if (score != null) {
    ...
    EvaluationofdrawingquestionsPage = tslib_1.__decorate([
        Component({
    ...
    ], EvaluationofdrawingquestionsPage);
    return EvaluationofdrawingquestionsPage;
}());
export { EvaluationofdrawingquestionsPage };
//# sourceMappingURL=evaluationofdrawingquestions.page.js.map